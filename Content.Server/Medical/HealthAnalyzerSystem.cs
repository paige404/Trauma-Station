...
public sealed class HealthAnalyzerSystem : EntitySystem
{
    ...
    /// Trauma: private -> internal for Monolith Cortical Borer Port
    internal void BeginAnalyzingEntity(Entity<HealthAnalyzerComponent> healthAnalyzer, EntityUid target, EntityUid? part = null)
    {
    ...
    /// Trauma: private -> internal for Monolith Cortical Borer Port
    internal void StopAnalyzingEntity(Entity<HealthAnalyzerComponent> healthAnalyzer, EntityUid target)
    {
        //Unlink the analyzer

...
public abstract partial class SharedSurgerySystem
{
    ...
    private void InitializeSteps()
    {
        ...
        SubSurgery<_Mono.CorticalBorer.Components.SurgeryStepRemoveCorticalBorerComponent>(OnCorticalBorerRemovalStep, OnCorticalBorerRemovalCheck);
        // Monolith Port end
    ...
    // Monolith Cortical Borer Port
    private void OnCorticalBorerRemovalStep(Entity<_Mono.CorticalBorer.Components.SurgeryStepRemoveCorticalBorerComponent> ent, ref SurgeryStepEvent args)
    {
        if (TryComp<_Mono.CorticalBorer.Components.CorticalBorerInfestedComponent>(args.Body, out var infested) &&
            infested.InfestationContainer.ContainedEntities.Count != 0)
            _corticalBorer.TryEjectBorer(infested.Borer, true);
    }

    private void OnCorticalBorerRemovalCheck(Entity<_Mono.CorticalBorer.Components.SurgeryStepRemoveCorticalBorerComponent> ent, ref SurgeryStepCompleteCheckEvent args)
    {
